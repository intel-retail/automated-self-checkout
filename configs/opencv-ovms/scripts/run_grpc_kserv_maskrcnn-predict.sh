...
python3 /scripts/run_grpc_python.py --input_src 'rtsp://192.168.0.246:8554/camera_0' --grpc_address 127.0.0.1 --grpc_port $GRPC_PORT --model_name  instance-segmentation-security-1040 2>&1