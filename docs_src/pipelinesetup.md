...
**_Note:_**  For the list of pre-trained models, refer to the [Model List](https://github.com/intel-retail/automated-self-checkout/blob/1.5.0/configs/dlstreamer/models/2022/models.list.yml).
