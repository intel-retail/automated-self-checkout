...
| [Docker* images](../pipelinesetup_dlstreamer.md#step-4-build-the-reference-design-docker-images)       | Dockerized images for the pipeline and benchmark tools for code portability |
| [Set up Documentation](../pipelinesetup_dlstreamer.md)                                                  | Markdown files that include setup steps for initial use                     |
...
| [Model downloader script](../pipelinesetup_dlstreamer.md#step-3-download-models-manually-optional)      | Script to assist with downloading the model files used for the pipelines    |
