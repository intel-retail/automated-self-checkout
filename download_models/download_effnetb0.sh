...
if [ ! -f "$TARGET_DIR/imagenet_2012.txt" ]; then
    wget "https://raw.githubusercontent.com/open-edge-platform/dlstreamer/refs/heads/master/samples/labels/imagenet_2012.txt" -O "$TARGET_DIR/imagenet_2012.txt"
...
if [ ! -f "$TARGET_DIR/preproc-aspect-ratio.json" ]; then
    wget "https://raw.githubusercontent.com/open-edge-platform/dlstreamer/refs/heads/master/samples/gstreamer/model_proc/public/preproc-aspect-ratio.json" -O "$TARGET_DIR/preproc-aspect-ratio.json"
