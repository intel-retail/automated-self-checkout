...
./docker-run.sh --platform core --inputsrc rtsp://127.0.0.1:8554/camera_0 --ocr 5 CPU --barcode
...
./docker-run.sh --platform core --inputsrc rtsp://127.0.0.1:8554/camera_0 --ocr 5 CPU --barcode 5
